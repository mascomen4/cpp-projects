...
int main( void )
{
	...
	GLuint programID = LoadShaders( "../tutorial14_render_to_texture/StandardShadingRTT.vertexshader",
	...
	// Create and compile our GLSL program from the shaders
	GLuint quad_programID = LoadShaders( "../tutorial14_render_to_texture/Passthrough.vertexshader",
